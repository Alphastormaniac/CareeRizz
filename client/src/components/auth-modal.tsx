          ...
          <div className="w-full lg:w-1/2 p-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <Button 
                ...
                className="h-12 border-2 hover:border-red-300 hover:bg-red-50 transition-all duration-200"
              >
              ...
              <Button 
                ...
                className="h-12 border-2 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200"
              >
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <Button 
                ...
                className="h-12 border-2 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
              >
